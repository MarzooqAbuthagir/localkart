...
public class MyBusinessActivity4 extends AppCompatActivity implements OnMapReadyCallback, LocationListener,
    ...
    private String Tag = "MyBusinessActivity4";
    Utilis utilis;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_business4);

        utilis = new Utilis(MyBusinessActivity4.this);
        ...
        window.setStatusBarColor(ContextCompat.getColor(MyBusinessActivity4.this, R.color.colorPrimaryDark));
        ...
        if (!Places.isInitialized()) {
            Places.initialize(MyBusinessActivity4.this, apiKey);
        }
        ...
        tvPlacesSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ).build(MyBusinessActivity4.this);
    ...
    private void fetchLastLocation() {
        ...
        if (Utilis.isGpsOn()) {
            try {
                ...
                supportMapFragment.getMapAsync(MyBusinessActivity4.this);
            } catch (Exception e) {
    ...
    private void getAddress(double latitude, double longitude) {
        Geocoder geocoder = new Geocoder(MyBusinessActivity4.this, Locale.getDefault());
        try {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        if (Utilis.isGpsOn()) {
            ...
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
                    ...
                    != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(MyBusinessActivity4.this,
    ...
    private void updateUI(Location location) {
        LocationData locData = Utilis.getLocDetails(MyBusinessActivity4.this);
        if (locData != null) {
