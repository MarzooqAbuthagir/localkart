...
public class ViewJobActivity extends AppCompatActivity {
    ...
    String keyIntent = "", strFromDate = "", strToDate = "", strAccessOption = "", strLati = "", strLongi = "", strFDate = "", strTDate = "";
...
//    final long PERIOD_MS = 4500; // time in milliseconds between successive task executions.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        utils = new Utils(ViewJobActivity.this);
        ...
        window.setStatusBarColor(ContextCompat.getColor(ViewJobActivity.this, R.color.colorPrimaryDark));
        ...
        toolBarTitle.setText("Job Openings");
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(ViewJobActivity.this);
        recyclerView.setLayoutManager(layoutManager);

        offerAdapter = new OfferAdapter(this, offerDataList, 0, false, keyIntent, "", "", "", "");
        recyclerView.setAdapter(offerAdapter);

        TextView tvOfferTitle = findViewById(R.id.tv_offer_title);
        if (offerDataList.size() > 1) {
            tvOfferTitle.setText("Job Openings");
        } else {
            tvOfferTitle.setText("Job Opening");
        }
    ...
    private void postValidation() {
        ...
        builder.setMessage("Job post details cannot be changed once saved. Are you sure you want to save and show this job opening to customer?")
                .setPositiveButton(ViewJobActivity.this.getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {

                    public void onClick(DialogInterface dialog, int which) {
                        // Do nothing but close the dialog
                        dialog.dismiss();
                        if (Utils.isInternetOn()) {
                            Utils.showProgress(ViewJobActivity.this);
                            ...
                            StringRequest stringRequest = new StringRequest(Request.Method.POST, Utils.Api + Utils.jobpostvalidation, new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if (Integer.parseInt(str_result) == 0) {
                                            ...
                                            str_message = obj.getString("Message");
                                            Toast.makeText(ViewJobActivity.this, str_message, Toast.LENGTH_SHORT).show();
                                        }
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    ...
                                    Utils.dismissProgress();
                                    Toast.makeText(ViewJobActivity.this, ViewJobActivity.this.getResources().getString(R.string.somethingwentwrong), Toast.LENGTH_SHORT).show();
                            ...
                            VolleySingleton.getInstance(ViewJobActivity.this).addToRequestQueue(stringRequest);
                        } else {
                            Toast.makeText(ViewJobActivity.this, ViewJobActivity.this.getResources().getString(R.string.nointernet), Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                .setNegativeButton(ViewJobActivity.this.getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
    ...
    private void sendPost() {
        if (Utils.isInternetOn()) {
                        ...
                        if (Integer.parseInt(str_result) == 0) {
                            ...
                            builder.setMessage("Your job post has been successfully saved.")
                                    .setNeutralButton("OK", new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            dialog.dismiss();
                                            Intent intent = new Intent(ViewJobActivity.this, ManageBusinessActivity.class);
            ...
            Toast.makeText(this, ViewJobActivity.this.getResources().getString(R.string.nointernet), Toast.LENGTH_SHORT).show();
        }
    }
        ...
        if (Utils.isInternetOn()) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Utils.Api + Utils.viewoffer, new Response.Listener<String>() {
                ...
                protected Map<String, String> getParams() {
                    Map<String, String> params = new HashMap<>();
                    params.put("userIndexId", obj.getId());
                    params.put("type", RegBusinessTypeSharedPreference.getBusinessType(ViewJobActivity.this));
    ...
    private void setShopBanners(final List<ShopBanner> shopBannerList) {
        viewPagerAdapter = new ViewPagerShopBannerAdapter(shopBannerList, ViewJobActivity.this);
...
//        }, DELAY_MS, PERIOD_MS);
    ...
    private void addDot(int dotPosition) {
        ...
        for (int j = 0; j < dotscount; j++) {
            ...
            dots[j] = new ImageView(ViewJobActivity.this);
