...
public class ManageEventBookingDetailActivity extends AppCompatActivity {
    private String Tag = "ManageEventBookingDetailActivity";
    Utils utils;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_event_booking_detail);

        utils = new Utils(ManageEventBookingDetailActivity.this);
        ...
        window.setStatusBarColor(ContextCompat.getColor(ManageEventBookingDetailActivity.this, R.color.colorPrimaryDark));
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(ManageEventBookingDetailActivity.this);
        recyclerView.setHasFixedSize(true);
        recyclerView.setNestedScrollingEnabled(false);
        recyclerView.setLayoutManager(layoutManager);

        recyclerViewConvFee = findViewById(R.id.recycler_view_conv_fee);
        RecyclerView.LayoutManager layoutManager1 = new LinearLayoutManager(ManageEventBookingDetailActivity.this);
...
//        Drawable mDivider = ContextCompat.getDrawable(ManageEventBookingDetailActivity.this, R.drawable.divider_line);
//        DividerItemDecoration itemDecoration = new DividerItemDecoration(ManageEventBookingDetailActivity.this, DividerItemDecoration.VERTICAL);
//        itemDecoration.setDrawable(mDivider);
        RecyclerView.ItemDecoration itemDecoration = new DividerItemDecorator(ContextCompat.getDrawable(ManageEventBookingDetailActivity.this, R.drawable.new_divider_line));
        recyclerView.addItemDecoration(itemDecoration);
        recyclerViewConvFee.addItemDecoration(itemDecoration);

        recyclerViewGST = findViewById(R.id.recycler_view_gst);
        RecyclerView.LayoutManager layoutManager2 = new LinearLayoutManager(ManageEventBookingDetailActivity.this);
        ...
        if (Utils.isInternetOn()) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, Utils.Api + Utils.eventbookingdetails + "?id="+eventId, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (Integer.parseInt(str_result) == 0) {
                            ...
                            TicketAdapter adapter = new TicketAdapter(ManageEventBookingDetailActivity.this, tickets);
                            ...
                            TicketAdapter adapter1 = new TicketAdapter(ManageEventBookingDetailActivity.this, ticketsConvFee);
                            ...
                            GSTAdapter adapter2 = new GSTAdapter(ManageEventBookingDetailActivity.this, gstArrayList);
                            recyclerViewGST.setAdapter(adapter2);

                        } else if (Integer.parseInt(str_result) == 2) {
                            str_message = obj.getString("message");
                            Toast.makeText(ManageEventBookingDetailActivity.this, str_message, Toast.LENGTH_SHORT).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Utils.dismissProgress();
                    Toast.makeText(ManageEventBookingDetailActivity.this, ManageEventBookingDetailActivity.this.getResources().getString(R.string.somethingwentwrong), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, ManageEventBookingDetailActivity.this.getResources().getString(R.string.nointernet), Toast.LENGTH_SHORT).show();
        }
    }
