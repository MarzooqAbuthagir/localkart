package com.localkartmarketing.localkart.support.tooltip;
...
public class SimpleTooltip implements PopupWindow.OnDismissListener {
    ...
    // Default Resources
    private static final int M_DEFAULT_POPUP_WINDOW_STYLE_RES = android.R.attr.popupWindowStyle;
    private static final int M_DEFAULT_TEXT_APPEARANCE_RES = R.style.simpletooltip_default;
    private static final int M_DEFAULT_BACKGROUND_COLOR_RES = R.color.simpletooltip_background;
    private static final int M_DEFAULT_TEXT_COLOR_RES = R.color.simpletooltip_text;
    private static final int M_DEFAULT_ARROW_COLOR_RES = R.color.simpletooltip_arrow;
    private static final int M_DEFAULT_MARGIN_RES = R.dimen.simpletooltip_margin;
    private static final int M_DEFAULT_PADDING_RES = R.dimen.simpletooltip_padding;
    private static final int M_DEFAULT_ANIMATION_PADDING_RES = R.dimen.simpletooltip_animation_padding;
    private static final int M_DEFAULT_ANIMATION_DURATION_RES = R.integer.simpletooltip_animation_duration;
    private static final int M_DEFAULT_ARROW_WIDTH_RES = R.dimen.simpletooltip_arrow_width;
    private static final int M_DEFAULT_ARROW_HEIGHT_RES = R.dimen.simpletooltip_arrow_height;
    private static final int M_DEFAULT_OVERLAY_OFFSET_RES = R.dimen.simpletooltip_overlay_offset;
    ...
    private void configPopupWindow() {
        mPopupWindow = new PopupWindow(mContext, null, M_DEFAULT_POPUP_WINDOW_STYLE_RES);
    ...
    private void checkAndSetTextViewText() {
    ...
    public static class Builder {
        ...
        public SimpleTooltip build() {
            ...
            if (backgroundColor == 0) {
                backgroundColor = SimpleTooltipUtils.getColor(context, M_DEFAULT_BACKGROUND_COLOR_RES);
            }
            if (textColor == 0) {
                textColor = SimpleTooltipUtils.getColor(context, M_DEFAULT_TEXT_COLOR_RES);
            }
            if (contentView == null) {
                TextView tv = new TextView(context);
                SimpleTooltipUtils.setTextAppearance(tv, M_DEFAULT_TEXT_APPEARANCE_RES);
                tv.setBackgroundColor(backgroundColor);
                tv.setTextColor(textColor);
                contentView = tv;
            }
            if (arrowColor == 0) {
                arrowColor = SimpleTooltipUtils.getColor(context, M_DEFAULT_ARROW_COLOR_RES);
            }
            if (margin < 0) {
                margin = context.getResources().getDimension(M_DEFAULT_MARGIN_RES);
            }
            if (padding < 0) {
                padding = context.getResources().getDimension(M_DEFAULT_PADDING_RES);
            }
            if (animationPadding < 0) {
                animationPadding = context.getResources().getDimension(M_DEFAULT_ANIMATION_PADDING_RES);
            }
            if (animationDuration == 0) {
                animationDuration = context.getResources().getInteger(M_DEFAULT_ANIMATION_DURATION_RES);
            }
            ...
            if (overlayOffset < 0) {
                overlayOffset = context.getResources().getDimension(M_DEFAULT_OVERLAY_OFFSET_RES);
            }
        ...
        private void showArrow() {
            if (showArrow) {
                ...
                if (arrowWidth == 0)
                    arrowWidth = context.getResources().getDimension(M_DEFAULT_ARROW_WIDTH_RES);
                if (arrowHeight == 0)
                    arrowHeight = context.getResources().getDimension(M_DEFAULT_ARROW_HEIGHT_RES);
            }
        }
         ...
         */
        Builder contentView(TextView textView) {
         ...
         * @see Builder#contentView(int)
         */
        Builder contentView(View contentView, @IdRes int textViewId) {
         ...
         * @see Builder#contentView(int)
         */
        Builder contentView(@LayoutRes int contentViewId, @IdRes int textViewId) {
         ...
         * @see Builder#contentView(int, int)
         */
        Builder contentView(@LayoutRes int contentViewId) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            assert inflater != null;
            this.contentView = inflater.inflate(contentViewId, null, false);
            this.textViewId = 0;
         ...
         */
        Builder dismissOnInsideTouch(boolean dismissOnInsideTouch) {
         ...
         */
        Builder dismissOnOutsideTouch(boolean dismissOnOutsideTouch) {
         ...
         */
        @TargetApi(Build.VERSION_CODES.HONEYCOMB)
        Builder animationPadding(float animationPadding) {
         ...
         */
        @TargetApi(Build.VERSION_CODES.HONEYCOMB)
        Builder animationPadding(@DimenRes int animationPaddingRes) {
         ...
         */
        Builder margin(@DimenRes int marginRes) {
        ...
        /**
         * <div class="pt">Altura da seta indicativa. Esse valor é automaticamente definido em Largura ou Altura conforme a <tt>{@link Gravity}</tt> configurada.
         * Este valor sobrescreve <tt>{@link R.dimen.simpletooltip_arrow_height}</tt></div>
         * <div class="en">Height of the arrow. This value is automatically set in the Width or Height as the <tt>{@link Gravity}</tt>.</div>
         *
        ...
        /**
         * <div class="pt">Largura da seta indicativa. Esse valor é automaticamente definido em Largura ou Altura conforme a <tt>{@link Gravity}</tt> configurada.
         * Este valor sobrescreve <tt>{@link R.dimen.simpletooltip_arrow_width}</tt></div>
         * <div class="en">Width of the arrow. This value is automatically set in the Width or Height as the <tt>{@link Gravity}</tt>.</div>
         *
         * @param arrowWidth <div class="pt">Largura em pixels.</div>
         *                   <div class="en">Width in pixels.</div>
         * @return this
         */
        Builder arrowWidth(float arrowWidth) {
